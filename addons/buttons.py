from telebot.types import ReplyKeyboardRemove, InlineQueryResultArticle, KeyboardButton, ReplyKeyboardMarkup, InlineKeyboardButton, InlineKeyboardMarkup
...
inline_button_channel_link_en = InlineKeyboardButton("Information provided by CS:GO Beta", "https://t.me/csgobeta")
...
# Profile Information
markup_profile_en = ReplyKeyboardMarkup(
...
devcount_en = KeyboardButton('Developers in-game')
...
# DC Asia
markup_DC_Asia_en = ReplyKeyboardMarkup(
...
# Pistols
markup_pistols_en = ReplyKeyboardMarkup(
    row_width=4, resize_keyboard=True)
...
# Crosshair
markup_crosshair_en = ReplyKeyboardMarkup(
...
inline_button_channel_link_ru = InlineKeyboardButton("Новости о CS:GO", "https://t.me/csgobeta")
...
markup_profile_ru = ReplyKeyboardMarkup(
    row_width=1, resize_keyboard=True)
...
devcount_ru = KeyboardButton('Разработчиков в игре')
...
# DC Asia
markup_DC_Asia_ru = ReplyKeyboardMarkup(
    row_width=4, resize_keyboard=True)
...
# Pistols
markup_pistols_ru = ReplyKeyboardMarkup(
    row_width=4, resize_keyboard=True)
...
# Crosshair
markup_crosshair_ru = ReplyKeyboardMarkup(
    row_width=2, resize_keyboard=True)
